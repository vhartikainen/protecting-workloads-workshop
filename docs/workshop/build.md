...
!!! info  "To get started at an *AWS event* where the *Event Engine* is being used" 
	...
	7. Click **[here](/workshop/perimeter-layer/assess.md))** to proceed to the Assess phase.
...
You can now proceed to the [Assess Phase](/workshop/perimeter-layer/assess.md).
